...
const names = [
    {
        ...
        option: [
            ...
            'Correos para todas las actualizaciones',
        ],
    ...
    },
    {
        ...
        button: 'Empezar prueba gratuita',
        option: [
            'Todas las características de Lite',
            'Plantillas de facturas personalizadas',
            'Soporte para cálculo de impuestos',
        ...
        <section id='pricing' className='bg-header relative py-20'>
            ...
            <div className='container px-4'>
                ...
                <p className='text-lg font-normal text-center text-black/60 pt-5'>
                    Elige el plan que mejor se adapte a tu negocio. Todos nuestros planes incluyen un periodo de prueba gratuito.
                </p>
                        ...
                        <div
                            ...
                            <h2 className='text-4xl sm:text-5xl font-semibold text-midnight_text mb-3 group-hover:text-white'>
                                ...
                                {selectedCategory === 'monthly'
                                    ? item.price.monthly
                                    : item.price.yearly}
                                /<span className='text-lightgrey'>mes</span>
                            </h2>
