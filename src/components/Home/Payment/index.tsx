                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 space-x-1'>
                    ...
                    <div className='col-span-6 flex flex-col justify-center'>
                        <h2 className='text-midnight_text text-4xl sm:text-5xl font-semibold text-center lg:text-start leading-140!'>
                            Ahora es el momento de cambiar el método de pago.
                        </h2>
                        <p className='text-black/75 text-lg font-normal text-center lg:text-start leading-180! pt-3'>
                            Ofrecemos una variedad de métodos de pago para adaptarnos a tus necesidades. Elige el que más te convenga y empieza a disfrutar de nuestros servicios.
                        </p>
                        <Link
                            href={'/'}
                            scroll={false}
