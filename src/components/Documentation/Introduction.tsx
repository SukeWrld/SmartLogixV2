            ...
            <div id='version' className='md:scroll-m-[180px] scroll-m-28'>
                ...
                <div className='mt-5'>
                    <p className='text-base font-medium text-muted text-opacity-60'>
                        La plantilla SmartLogix está construida con Tailwindcss y Nextjs.
                    </p>
                    <p className='text-base font-medium text-muted text-opacity-60'>
                        Este tema está listo para usar y puedes personalizarlo totalmente según tus requisitos.
                    </p>
                    <p className='text-base font-medium text-muted text-opacity-60'>
                        Para personalizar, debes tener conocimientos de NextJs, ReactJs, Tailwind y JSX para poder modificar esta plantilla.
                    </p>
                </div>
            </div>
